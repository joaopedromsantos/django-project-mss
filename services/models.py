...
class Service(models.Model):
    ...
    # Estes campos correspondem aos JOINs no seu código legado.
    ...
    billed_date = models.DateTimeField(blank=True, null=True, verbose_name="Data da Cobrança",
                                       help_text="Preenchido apenas quando o serviço é marcado como cobrado.")

    # --- Contato e Observações ---
    email = models.EmailField(max_length=254, blank=True, null=True, verbose_name="Email do Pedido")
